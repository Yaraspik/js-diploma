...
/***/ "./src/js/ArtificialIntelligence.js":
/*!******************************************!*\
  !*** ./src/js/ArtificialIntelligence.js ***!
  \******************************************/
...
/* harmony export */   "default": () => (/* binding */ ArtificialIntelligence)
/* harmony export */ });
...
/* harmony import */ var _Motion__WEBPACK_IMPORTED_MODULE_17__ = __webpack_require__(/*! ./Motion */ "./src/js/Motion.js");
...
var ArtificialIntelligence = /*#__PURE__*/function () {
  function ArtificialIntelligence() {
    _classCallCheck(this, ArtificialIntelligence);
  }
  _createClass(ArtificialIntelligence, null, [{
    key: "step",
    value: function step(ctrl) {
      var hoveredCell = ctrl.gameState.hoveredCell;
      var computerChars = ctrl.computerChars,
        playerChars = ctrl.playerChars;
      var _char = computerChars[Math.floor(Math.random() * computerChars.length)];
      var indexPlayerChars = playerChars.map(function (el) {
        return el.index;
      });
      var attackedCells = [];
      indexPlayerChars.forEach(function (index) {
        var smartCell = ctrl.gamePlay.smartCell[index];
        var motion = _Motion__WEBPACK_IMPORTED_MODULE_17__["default"].getMotion(_char, smartCell);
        if (motion.canAttack) {
          attackedCells.push(smartCell);
        }
      });
      if (attackedCells.length !== 0) {
        var attackedCell = attackedCells[Math.floor(Math.random() * attackedCells.length)];
        var attack = _char.character.attack;
        var playerChar = playerChars.find(function (el) {
          return el.index === attackedCell.index;
        });
        var defense = playerChar.character.defence;
        var damage = Math.max(attack - defense, attack * 0.1);
        ctrl.gamePlay.showDamage(attackedCell.index, damage).then(function () {
          playerChar.character.health -= damage;
          if (playerChar.character.health <= 0) {
            if (hoveredCell) {
              ctrl.gamePlay.deselectCell(hoveredCell);
            }
            var indexPlayerChar = ctrl.playerChars.indexOf(playerChar);
            ctrl.playerChars.splice(indexPlayerChar, 1);
            var selectedChar = ctrl.gameState.selectedChar;
        ...
        var _loop = function _loop() {
          var tempStep = _Motion__WEBPACK_IMPORTED_MODULE_17__["default"].createStep(_char);
          var foundComputerChar = ctrl.computerChars.find(function (el) {
            return el.index === tempStep.index;
          });
          var foundPlayerChar = ctrl.playerChars.find(function (el) {
            return el.index === tempStep.index;
          });
        ...
        ctrl.computerChars.map(function (el) {
          var result = el;
          if (el.index === _char.index) {
            result.row = step.row;
...
var Character = /*#__PURE__*/function () {
  ...
  _createClass(Character, [{
    ...
    value: function levelUp() {
      ...
      this.defence = Math.floor(Math.max(this.defence, this.defence * (80 + this.health) * 0.01));
      this.health += 80;
      if (this.health > 100) {
        this.health = 100;
      }
...
/* harmony import */ var core_js_modules_web_dom_collections_iterator_js__WEBPACK_IMPORTED_MODULE_16__ = __webpack_require__(/*! core-js/modules/web.dom-collections.iterator.js */ "./node_modules/core-js/modules/web.dom-collections.iterator.js");
/* harmony import */ var core_js_modules_web_dom_collections_iterator_js__WEBPACK_IMPORTED_MODULE_16___default = /*#__PURE__*/__webpack_require__.n(core_js_modules_web_dom_collections_iterator_js__WEBPACK_IMPORTED_MODULE_16__);
/* harmony import */ var _characters_Swordsman__WEBPACK_IMPORTED_MODULE_17__ = __webpack_require__(/*! ./characters/Swordsman */ "./src/js/characters/Swordsman.js");
...
/* harmony import */ var _characters_Magician__WEBPACK_IMPORTED_MODULE_19__ = __webpack_require__(/*! ./characters/Magician */ "./src/js/characters/Magician.js");
/* harmony import */ var _characters_Daemon__WEBPACK_IMPORTED_MODULE_20__ = __webpack_require__(/*! ./characters/Daemon */ "./src/js/characters/Daemon.js");
/* harmony import */ var _characters_Undead__WEBPACK_IMPORTED_MODULE_21__ = __webpack_require__(/*! ./characters/Undead */ "./src/js/characters/Undead.js");
/* harmony import */ var _characters_Vampire__WEBPACK_IMPORTED_MODULE_22__ = __webpack_require__(/*! ./characters/Vampire */ "./src/js/characters/Vampire.js");
/* harmony import */ var _generators__WEBPACK_IMPORTED_MODULE_23__ = __webpack_require__(/*! ./generators */ "./src/js/generators.js");
/* harmony import */ var _GamePlay__WEBPACK_IMPORTED_MODULE_24__ = __webpack_require__(/*! ./GamePlay */ "./src/js/GamePlay.js");
/* harmony import */ var _GameState__WEBPACK_IMPORTED_MODULE_25__ = __webpack_require__(/*! ./GameState */ "./src/js/GameState.js");
/* harmony import */ var _Motion__WEBPACK_IMPORTED_MODULE_26__ = __webpack_require__(/*! ./Motion */ "./src/js/Motion.js");
/* harmony import */ var _themes__WEBPACK_IMPORTED_MODULE_27__ = __webpack_require__(/*! ./themes */ "./src/js/themes.js");
/* harmony import */ var _ArtificialIntelligence__WEBPACK_IMPORTED_MODULE_28__ = __webpack_require__(/*! ./ArtificialIntelligence */ "./src/js/ArtificialIntelligence.js");
function _typeof(obj) { "@babel/helpers - typeof"; return _typeof = "function" == typeof Symbol && "symbol" == typeof Symbol.iterator ? function (obj) { return typeof obj; } : function (obj) { return obj && "function" == typeof Symbol && obj.constructor === Symbol && obj !== Symbol.prototype ? "symbol" : typeof obj; }, _typeof(obj); }
...
var GameController = /*#__PURE__*/function () {
  function GameController(gamePlay, stateService) {
    ...
    this.gameState = new _GameState__WEBPACK_IMPORTED_MODULE_25__["default"]();
  }
  _createClass(GameController, [{
    ...
    key: "cellEnterHandler",
    value: function cellEnterHandler() {
      this.gamePlay.addCellEnterListener(this.onCellEnter.bind(this));
    }
  }, {
    key: "cellLeaveHandler",
    value: function cellLeaveHandler() {
      this.gamePlay.addCellLeaveListener(this.onCellLeave.bind(this));
    }
  }, {
    key: "btnSaveGameClickHandler",
    value: function btnSaveGameClickHandler() {
      this.gamePlay.addSaveGameListener(this.onBtnSaveGameClick.bind(this));
    }
  }, {
    key: "btnNewGameClickHandler",
    value: function btnNewGameClickHandler() {
      this.gamePlay.addNewGameListener(this.onBtnNewGameClick.bind(this));
    }
  }, {
    key: "btnLoadGameClickHandler",
    value: function btnLoadGameClickHandler() {
    ...
    value: function startNewGame() {
      ...
      var playerTypes = [_characters_Bowman__WEBPACK_IMPORTED_MODULE_18__["default"], _characters_Swordsman__WEBPACK_IMPORTED_MODULE_17__["default"], _characters_Magician__WEBPACK_IMPORTED_MODULE_19__["default"]];
      var playerTeam = (0,_generators__WEBPACK_IMPORTED_MODULE_23__.generateTeam)(playerTypes, 3, 4);
      this.gameState.playerChars = (0,_generators__WEBPACK_IMPORTED_MODULE_23__.generatePosition)(playerTeam.characters, boardSize, true);
      var computerTypes = [_characters_Daemon__WEBPACK_IMPORTED_MODULE_20__["default"], _characters_Vampire__WEBPACK_IMPORTED_MODULE_22__["default"], _characters_Undead__WEBPACK_IMPORTED_MODULE_21__["default"]];
      var computerTeam = (0,_generators__WEBPACK_IMPORTED_MODULE_23__.generateTeam)(computerTypes, 3, 4);
      this.gameState.computerChars = (0,_generators__WEBPACK_IMPORTED_MODULE_23__.generatePosition)(computerTeam.characters, boardSize);
      this.gameState.level = 0;
      this.gameState.blockField = false;
      this.gamePlay.drawUi(_themes__WEBPACK_IMPORTED_MODULE_27__["default"][this.gameState.get('level')]);
      this.gamePlay.redrawPositions(this.gameState.positionedCharacters);
    }
  }, {
    key: "onBtnNewGameClick",
    value: function onBtnNewGameClick() {
      this.startNewGame();
    }
  }, {
    key: "onBtnSaveGameClick",
    value: function onBtnSaveGameClick() {
      this.gameState.computerChars = this.computerChars;
      this.gameState.playerChars = this.playerChars;
      this.stateService.save(this.gameState);
    }
  }, {
    key: "onBtnLoadGameClick",
    value: function onBtnLoadGameClick() {
      var res = this.stateService.load();
      ...
      this.gamePlay.drawUi(_themes__WEBPACK_IMPORTED_MODULE_27__["default"][res.level]);
      this.gamePlay.redrawPositions(this.gameState.positionedCharacters);
    }
  }, {
    key: "onCellClick",
    value: function onCellClick(index) {
      ...
      // if (!character) {
      //    // логика если это поле без персонажа
      //    return
      // }
      // if (this.gameState.userTeam.has(positionedCharacter.character)) {
      //   // логика, если это персонаж игрока
      //   return  
      // }
      // if (this.gameState.botTeam.has(positionedCharacter.character)) {
      //   // логика, если это персонаж бота ... вообще тут if можно упустить, сюда в любом случае уже будет доходить персонаж бота
      //   return  
      // }
      ...
      var hoveredCell = this.gameState.hoveredCell;
      var playerChar = this.gameState.playerChars.find(function (el) {
        return el.index === index;
      });
      var computerChar = this.gameState.computerChars.find(function (el) {
        return el.index === index;
      });
      var selectedChar = this.gameState.selectedChar;
      if (playerChar) {
        if (selectedChar) {
      ...
      if (computerChar) {
        if (!selectedChar) {
          _GamePlay__WEBPACK_IMPORTED_MODULE_24__["default"].showError('Выбери своего персонажа');
        } else {
          var smartCell = this.gamePlay.smartCell[index];
          var motion = _Motion__WEBPACK_IMPORTED_MODULE_26__["default"].getMotion(selectedChar, smartCell);
          if (motion.canAttack === false) {
            _GamePlay__WEBPACK_IMPORTED_MODULE_24__["default"].showError('Ты не можешь его атаковать');
          } else {
            var attack = this.gameState.selectedChar.character.attack;
            var defense = computerChar.character.defence;
            var damage = Math.max(attack - defense, attack * 0.1);
            this.gamePlay.showDamage(index, damage).then(function () {
              computerChar.character.health -= damage;
              if (computerChar.character.health <= 0) {
                var indexComputerChar = _this.computerChars.indexOf(computerChar);
                _this.computerChars.splice(indexComputerChar, 1);
                _this.gamePlay.redrawPositions(_this.playerChars, _this.computerChars);
                if (hoveredCell) {
                  _this.gamePlay.deselectCell(hoveredCell);
                }
              } else {
                _this.gamePlay.redrawPositions(_this.playerChars, _this.computerChars);
                _this.gameState.passMove('computer');
                _ArtificialIntelligence__WEBPACK_IMPORTED_MODULE_28__["default"].step(_this);
              }
              if (_this.computerChars.length === 0) {
                if (_this.gameState.get('level') === 3) {
                  _this.gameState.blockField = true;
                  _this.gamePlay.deselectCell(_this.gameState.selectedChar.index);
                } else {
                  var boardSize = _this.gamePlay.boardSize;
                  _this.playerChars.map(function (element) {
                    return element.character.levelUp();
                  });
                  _this.gameState.nextLevel();
                  var computerTypes = [_characters_Daemon__WEBPACK_IMPORTED_MODULE_20__["default"], _characters_Vampire__WEBPACK_IMPORTED_MODULE_22__["default"], _characters_Undead__WEBPACK_IMPORTED_MODULE_21__["default"]];
                  var computerTeam = (0,_generators__WEBPACK_IMPORTED_MODULE_23__.generateTeam)(computerTypes, 3, 4);
                  _this.computerChars = (0,_generators__WEBPACK_IMPORTED_MODULE_23__.generatePosition)(computerTeam.characters, boardSize);
                  var playerTeam = _this.playerChars.map(function (el) {
                    return el.character;
                  });
                  _this.playerChars = (0,_generators__WEBPACK_IMPORTED_MODULE_23__.generatePosition)(playerTeam, boardSize, true);
                  _this.gamePlay.drawUi(_themes__WEBPACK_IMPORTED_MODULE_27__["default"][_this.gameState.get('level')]);
                  if (_this.gameState.selectedChar) {
                    _this.gamePlay.deselectCell(_this.gameState.selectedChar.index);
                  }
                  _this.gameState.deselect();
                  _this.gamePlay.redrawPositions(_this.playerChars, _this.computerChars);
                }
              }
            });
      ...
      if (!computerChar && !playerChar && selectedChar) {
        var _smartCell = this.gamePlay.smartCell[index];
        var _motion = _Motion__WEBPACK_IMPORTED_MODULE_26__["default"].getMotion(selectedChar, _smartCell);
        if (_motion.canWalk === false) {
          _GamePlay__WEBPACK_IMPORTED_MODULE_24__["default"].showError('Ты не можешь так сходить');
        } else {
          this.gamePlay.deselectCell(this.gameState.selectedChar.index);
          selectedChar.row = _smartCell.row;
          selectedChar.column = _smartCell.column;
          selectedChar.index = _smartCell.index;
          this.gamePlay.selectCell(this.gameState.selectedChar.index);
          this.gamePlay.redrawPositions(this.playerChars, this.computerChars);
          this.gameState.passMove('computer');
          _ArtificialIntelligence__WEBPACK_IMPORTED_MODULE_28__["default"].step(this);
        }
      }
    }
  }, {
    ...
    value: function onCellEnter(index) {
      ...
      var positionedCharacter = this.gameState.getPositionedCharacterByPosition(index);
      if (!positionedCharacter) {
        this.gamePlay.setCursor('auto');
        return;
      }
      debugger;
      if (this.gameState.playerChars.has(positionedCharacter.character)) {
        console.log('gamer');
        return;
      }
      var selectedChar = this.gameState.selectedChar;
      ...
      if (positionedCharacter) {
        var message = "\uD83C\uDF96 ".concat(positionedCharacter.character.level, " \u2694 ").concat(positionedCharacter.character.attack, " \uD83D\uDEE1 ").concat(positionedCharacter.character.defence, " \u2764 ").concat(positionedCharacter.character.health);
...
/* harmony import */ var _utils__WEBPACK_IMPORTED_MODULE_24__ = __webpack_require__(/*! ./utils */ "./src/js/utils.js");
function _typeof(obj) { "@babel/helpers - typeof"; return _typeof = "function" == typeof Symbol && "symbol" == typeof Symbol.iterator ? function (obj) { return typeof obj; } : function (obj) { return obj && "function" == typeof Symbol && obj.constructor === Symbol && obj !== Symbol.prototype ? "symbol" : typeof obj; }, _typeof(obj); }
...
var GamePlay = /*#__PURE__*/function () {
  ...
  _createClass(GamePlay, [{
    ...
    value: function drawUi(theme) {
      ...
      this.smartCell = [];
      for (var row = 0; row <= this.boardSize - 1; row += 1) {
        var rowEl = document.createElement('div');
        rowEl.classList.add("row-".concat(row), 'row');
        for (var _column = 0; _column <= this.boardSize - 1; _column += 1) {
          var cellEl = document.createElement('div');
          cellEl.classList.add('cell', 'map-tile', "map-tile-".concat((0,_utils__WEBPACK_IMPORTED_MODULE_24__.calcTileType)(row, _column, this.boardSize)));
      ...
      this.cells = [];
      var column = Array.from(this.boardEl.children);
      column.forEach(function (el) {
        var _this$cells;
        (_this$cells = _this.cells).push.apply(_this$cells, _toConsumableArray(Array.from(el.children)));
      });
    }
    ...
    value: function redrawPositions(positions) {
      ...
      try {
        for (_iterator2.s(); !(_step2 = _iterator2.n()).done;) {
          ...
          var cellEl = this.boardEl.children[position.row].children[position.column];
          ...
          healthIndicatorEl.classList.add('health-level-indicator', "health-level-indicator-".concat((0,_utils__WEBPACK_IMPORTED_MODULE_24__.calcHealthLevel)(position.character.health)));
...
var GameState = /*#__PURE__*/function () {
  function GameState() {
    ...
    this.computerChars = new Set();
    this.playerChars = new Set();
  }
  _createClass(GameState, [{
    key: "positionedCharacters",
    get: function get() {
      return this.playerChars.concat(this.computerChars);
    }
  }, {
    key: "getPositionedCharacterByPosition",
    value: function getPositionedCharacterByPosition(position) {
      return this.positionedCharacters.find(function (_ref) {
    ...
    key: "set",
    value: function set(title, value) {
      this[title] = value;
    }
  }, {
    key: "nextLevel",
...
var Motion = /*#__PURE__*/function () {
  ...
  _createClass(Motion, null, [{
    key: "getMotion",
    value: function getMotion(_char, smartCell) {
      if (!_char) {
        return false;
      }
      var canWalk = false;
      var canAttack = false;
      var _char$character = _char.character,
        stepRange = _char$character.stepRange,
        attackRange = _char$character.attackRange;
      var row = _char.row,
        column = _char.column;
      var stepRow = Math.abs(row - smartCell.row);
      var stepColumn = Math.abs(column - smartCell.column);
      var attackRow = Math.abs(row - smartCell.row);
      var attackColumn = Math.abs(column - smartCell.column);
    ...
    key: "createStep",
    value: function createStep(_char2) {
      var stepRange = _char2.character.stepRange;
      var row = _char2.row,
        column = _char2.column;
      var stepFromRow = row - stepRange < 0 ? 0 : row - stepRange;
      var stepToRow = row + stepRange > 7 ? 7 : row + stepRange;
      var stepFromColumn = column - stepRange < 0 ? 0 : column - stepRange;
      var stepToColumn = column + stepRange > 7 ? 7 : column + stepRange;
      var canWalk = false;
      var smartCell = null;
      while (canWalk === false) {
        var stepRow = Motion.getRandomIntInclusive(stepFromRow, stepToRow);
        var stepColumn = Motion.getRandomIntInclusive(stepFromColumn, stepToColumn);
        var stepIndex = stepRow * 8 + stepColumn;
        smartCell = {
          row: stepRow,
          column: stepColumn,
          index: stepIndex
        };
        var motion = this.getMotion(_char2, smartCell);
        if (motion.canWalk) {
          canWalk = true;
        }
      }
...
/* harmony import */ var core_js_modules_web_dom_collections_iterator_js__WEBPACK_IMPORTED_MODULE_10__ = __webpack_require__(/*! core-js/modules/web.dom-collections.iterator.js */ "./node_modules/core-js/modules/web.dom-collections.iterator.js");
/* harmony import */ var core_js_modules_web_dom_collections_iterator_js__WEBPACK_IMPORTED_MODULE_10___default = /*#__PURE__*/__webpack_require__.n(core_js_modules_web_dom_collections_iterator_js__WEBPACK_IMPORTED_MODULE_10__);
/* harmony import */ var _Character__WEBPACK_IMPORTED_MODULE_11__ = __webpack_require__(/*! ./Character */ "./src/js/Character.js");
...
var PositionedCharacter = /*#__PURE__*/_createClass(function PositionedCharacter(character, row, column) {
  _classCallCheck(this, PositionedCharacter);
  if (!(character instanceof _Character__WEBPACK_IMPORTED_MODULE_11__["default"])) {
...
/* harmony import */ var _Character__WEBPACK_IMPORTED_MODULE_16__ = __webpack_require__(/*! ../Character */ "./src/js/Character.js");
function _typeof(obj) { "@babel/helpers - typeof"; return _typeof = "function" == typeof Symbol && "symbol" == typeof Symbol.iterator ? function (obj) { return typeof obj; } : function (obj) { return obj && "function" == typeof Symbol && obj.constructor === Symbol && obj !== Symbol.prototype ? "symbol" : typeof obj; }, _typeof(obj); }
...
}(_Character__WEBPACK_IMPORTED_MODULE_16__["default"]);
...
/* harmony export */   generatePosition: () => (/* binding */ generatePosition),
/* harmony export */   generateTeam: () => (/* binding */ generateTeam),
/* harmony export */   positionGenerator: () => (/* binding */ positionGenerator)
/* harmony export */ });
...
/* harmony import */ var _Team__WEBPACK_IMPORTED_MODULE_29__ = __webpack_require__(/*! ./Team */ "./src/js/Team.js");
/* harmony import */ var _PositionedCharacter__WEBPACK_IMPORTED_MODULE_30__ = __webpack_require__(/*! ./PositionedCharacter */ "./src/js/PositionedCharacter.js");
function _typeof(obj) { "@babel/helpers - typeof"; return _typeof = "function" == typeof Symbol && "symbol" == typeof Symbol.iterator ? function (obj) { return typeof obj; } : function (obj) { return obj && "function" == typeof Symbol && obj.constructor === Symbol && obj !== Symbol.prototype ? "symbol" : typeof obj; }, _typeof(obj); }
function _createForOfIteratorHelper(o, allowArrayLike) { var it = typeof Symbol !== "undefined" && o[Symbol.iterator] || o["@@iterator"]; if (!it) { if (Array.isArray(o) || (it = _unsupportedIterableToArray(o)) || allowArrayLike && o && typeof o.length === "number") { if (it) o = it; var i = 0; var F = function F() {}; return { s: F, n: function n() { if (i >= o.length) return { done: true }; return { done: false, value: o[i++] }; }, e: function e(_e) { throw _e; }, f: F }; } throw new TypeError("Invalid attempt to iterate non-iterable instance.\nIn order to be iterable, non-array objects must have a [Symbol.iterator]() method."); } var normalCompletion = true, didErr = false, err; return { s: function s() { it = it.call(o); }, n: function n() { var step = it.next(); normalCompletion = step.done; return step; }, e: function e(_e2) { didErr = true; err = _e2; }, f: function f() { try { if (!normalCompletion && it["return"] != null) it["return"](); } finally { if (didErr) throw err; } } }; }
function _unsupportedIterableToArray(o, minLen) { if (!o) return; if (typeof o === "string") return _arrayLikeToArray(o, minLen); var n = Object.prototype.toString.call(o).slice(8, -1); if (n === "Object" && o.constructor) n = o.constructor.name; if (n === "Map" || n === "Set") return Array.from(o); if (n === "Arguments" || /^(?:Ui|I)nt(?:8|16|32)(?:Clamped)?Array$/.test(n)) return _arrayLikeToArray(o, minLen); }
function _arrayLikeToArray(arr, len) { if (len == null || len > arr.length) len = arr.length; for (var i = 0, arr2 = new Array(len); i < len; i++) arr2[i] = arr[i]; return arr2; }
...
var _marked = /*#__PURE__*/_regeneratorRuntime().mark(characterGenerator),
  _marked2 = /*#__PURE__*/_regeneratorRuntime().mark(positionGenerator);
...
function characterGenerator(allowedTypes, maxLevel) {
  var randomTypeIndex, CharacterType, level;
  return _regeneratorRuntime().wrap(function characterGenerator$(_context) {
    while (1) switch (_context.prev = _context.next) {
      case 0:
        if (false) {}
        randomTypeIndex = Math.floor(Math.random() * allowedTypes.length);
        CharacterType = allowedTypes[randomTypeIndex];
        level = Math.floor(Math.random() * maxLevel + 1);
        _context.next = 6;
        return new CharacterType(level);
      case 6:
        _context.next = 0;
        break;
      case 8:
...
function generateTeam(allowedTypes, maxLevel, characterCount) {
  var iterator = characterGenerator(allowedTypes, maxLevel);
  var characters = [];
  while (characters.length < characterCount) {
    var character = iterator.next().value;
    if (character.level > 1) {
      for (var i = 0; i < character.level; i += 1) {
        character.levelUp();
      }
    }
    characters.push(character);
  }
  return new _Team__WEBPACK_IMPORTED_MODULE_29__["default"](characters);
}
function positionGenerator(boardSize, player) {
  var row, column, id, position;
  return _regeneratorRuntime().wrap(function positionGenerator$(_context2) {
    while (1) switch (_context2.prev = _context2.next) {
      case 0:
        ...
        id = Number("".concat(row).concat(column));
        position = {
          row: row,
          column: column,
          id: id
...
function generatePosition(characters, boardSize) {
  var player = arguments.length > 2 && arguments[2] !== undefined ? arguments[2] : false;
  var iterator = positionGenerator(boardSize, player);
  var positionedCharacter = [];
  var closedPosition = new Set();
  var _iterator = _createForOfIteratorHelper(characters),
    _step;
  try {
    for (_iterator.s(); !(_step = _iterator.n()).done;) {
      var character = _step.value;
      var position = iterator.next().value;
      while (closedPosition.has(position.id)) {
        position = iterator.next().value;
      }
      closedPosition.add(position.id);
      positionedCharacter.push(new _PositionedCharacter__WEBPACK_IMPORTED_MODULE_30__["default"](character, position.row, position.column));
    }
  } catch (err) {
    _iterator.e(err);
  } finally {
...
/* harmony export */ });
var themes = ['prairie', 'desert', 'arctic', 'mountain'];
 ...
 * center
 * */
function calcTileType(row, column, boardSize) {
